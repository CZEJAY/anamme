        ...
        return (
          <React.Fragment key={index}>
            {index === Math.floor(integrations.length / 2) && (
              <>
                <div className="pulsing-icon relative flex aspect-square shrink-0 items-center justify-center rounded-full border border-blue-50/30 bg-blue-600/25 p-3 text-3xl text-blue-100 opacity-40 md:text-4xl lg:text-5xl">
